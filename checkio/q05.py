...
def count_occurrences_v2(main_string: str, substring: str) -> int:
    main_string = main_string.lower()
    substring = substring.lower()
    count = start = 0
...
assert count_occurrences_v2("Hello World hello", "hello") == 2
